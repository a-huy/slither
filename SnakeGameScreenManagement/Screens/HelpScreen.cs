...
namespace SnakeGameScreenManagement
{
    class HelpScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            instructionsBackground = content.Load<Texture2D>("Backgrounds/instructions");
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Vector2 backgroundSize = new Vector2(800, 600);
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(instructionsBackground, backgroundRect, color);
            spriteBatch.End();
